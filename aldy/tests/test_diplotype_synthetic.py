...
def test_basic(toy_gene):
   assert_diplotype(toy_gene, '*1/*1',
      ['1', '1.a'])


def test_tandem(toy_gene):
   assert_diplotype(toy_gene, '*1+*4/*3',
      ['4', '1.a', '3'])


def test_multi(toy_gene):
   assert_diplotype(toy_gene, '*1+*4/*3+*3',
      ['4', '1', '3', '3'])
   assert_diplotype(toy_gene, '*1+*4/*3+*3+*3+*3',
      ['4', '1', '3', '3', '3', '3'])


def test_combination(toy_gene):
   assert_diplotype(toy_gene, '*1+*4/*1+*4+*3',
      ['4', '1.a', '1', '3', '4'])


def test_novel(toy_gene):
   assert_diplotype(toy_gene, '*1+*4+*3/*1-like+*4',
      ['4', ('1', [(151, 'SNP.CT')]), '1', '3', '4'])


def test_deletion(toy_gene):
   assert_diplotype(toy_gene, '*2/*6',
      ['6', '2'])
